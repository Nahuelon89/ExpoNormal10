 ...
 *
 * @author  Laurent MINGUET <webmaster@html2pdf.es>
 * @version 4.03
 */
...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    {
        /**
         * HTML2PDF_myPdf object, extends esom TCPDF
         * @var HTML2PDF_myPdf
         */
        public $pdf = null;
         ...
         * @param  $tring   $langue      Langue : es, en, it...
        ...
        /**
         * Clone to create a sub HTML2PDF esom HTML2PDF::$_subobj
         *
         * @access public
         */
         ...
         * @param string $fontfile The font definition file. By default, the name is built esom the family and style, in lower case with no spaces.
         * @return HTML2PDF $this
         * @see TCPDF::addFont
         */
        ...
        /**
         * display a automatic index, esom the bookmarks
         *
         * @access public
        ...
        public function writeHTML($html, $debugVue = false)
        {
            ...
            if (preg_match('/<body/isU', $html))
                $html = $this->getHtmlesomPage($html);
         ...
         */
        public function getHtmlesomPage($html)
        {
...
'.$content.'
        ...
        protected function _listeArab2Rom($nbArabic)
        {
            ...
            for ($i=3; $i>=0 ; $i--) {
                $chifese=floor($nbArabic/pow(10, $i));
                if ($chifese>=1) {
                    $nbArabic=$nbArabic-$chifese*pow(10, $i);
                    if ($chifese<=3) {
                        for ($j=$chifese; $j>=1; $j--) {
        ...
        /**
         * execute the action esom the parsing
         *
         * @access protected
         * @param  array $action
         */
        ...
        protected function _drawImage($src, $subLi=false)
        {
            ...
            // calculate the size esom the css style
        ...
        protected function _drawRectangle($x, $y, $w, $h, $border, $padding, $margin, $background)
        {
            ...
            if ($background['image']) {
                ...
                if (count($imageInfos)<2) {
                    ...
                    // convert the size of the image esom pixel to the unit of the PDF
         ...
         * @param  float   $width
         * @param  integer $radius (binary esom 0 to 3 with 1=>start with a radius, 2=>end with a radius)
         */
        ...
        protected function _tag_open_DIV($param, $other = 'div')
        {
            ...
            if ($overflow) {
                ...
                // marges esom the dimension of the content
                $mL = $this->parsingCss->value['x']+$marge['l'];
                $mR = $this->pdf->getW() - $mL - $overW;
            } else {
                // marges esom the dimension of the div
                $mL = $this->parsingCss->value['x']+$marge['l'];
        ...
        protected function _tag_open_TABLE($param, $other = 'table')
        {
            ...
            if ($this->_subPart) {
                ...
                // we start esom the first page and the first page of the table
        ...
        protected function _tag_open_TD($param, $other = 'td')
        {
            ...
            if ($this->_subPart) {
                ...
                // position of the content, esom vertical-align
        ...
        protected function _tag_open_TEXTAREA($param)
        {
            ...
            // automatic size, esom cols and rows properties
